...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 133640488L;
    ...
    //inherited
    public final ListPath<cashewnut.user.member.domain.Category, cashewnut.user.member.domain.QCategory> categories = _super.categories;
